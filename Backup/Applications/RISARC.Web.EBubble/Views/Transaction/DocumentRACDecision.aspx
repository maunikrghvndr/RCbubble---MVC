...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>RAC Decision Report</h2>
    <div class="floatRight clsMarginBottom10">
       <div class="floatLeft"> <img src="<%= Url.Content("~/Images/icons/exportExcel.png")  %>"" /> &nbsp;&nbsp;</div>
      <%= Html.ActionLink("Export to Excel", "ExportExcelSentRequests", new {  ReportType=(int)ExportGridSetting.RACDecisionReport })%>
   </div> 
    <%=Html.Partial("DocumentRacDescTransactions",Model) %>
