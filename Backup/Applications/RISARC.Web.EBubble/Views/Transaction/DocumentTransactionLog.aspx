...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Sent Documents Report</h2>
    
    Search document report by any of the below category
 <% using (Html.Configurator("")
.PostTo("DocumentTransactionLog", "Transaction")              
.Begin())   
{ %>    
...
<% } %>
    <div class="floatRight clsMarginBottom10">
      ...
      <%= Html.ActionLink("Export to Excel", "ExportExcelSentRequests", new {startDate=ViewData["StartDate"], endDate= ViewData["EndDate"], page = 1, acn=ViewData["Acn"], patientFName=ViewData["PatientFName"], patientLName=ViewData["PatientLName"], accountNo=ViewData["accountNo"], ReportType=(int)ExportGridSetting.SentDocumentsReport })%>
     </div>
    <%
            Html.RenderPartial("DocumentTransactionsTable",Model);
           %>
