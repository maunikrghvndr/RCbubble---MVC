...
<% 
    ...
    {
        settings.Name = "gvViewSentRequests";
        settings.KeyFieldName = "DocumentTypeName";
        settings.CallbackRouteValues = new { Controller = "ViewDocuments", Action = "_MySentRequests" };
        ...
        settings.Columns.Add(column =>
          ...
          settings.Columns.Add(column =>
          {
              ...
              column.FieldName = "MultipleRecipients";
              column.HeaderStyle.Wrap = DefaultBoolean.True;
              column.Width = 160;
              column.SetDataItemTemplateContent(c =>
              {
          ...
          settings.Columns.Add(column =>
          {
              ...
              column.FieldName = "DocumentRelatesToPatient";
              column.HeaderStyle.Wrap = DefaultBoolean.True;
              column.SetDataItemTemplateContent(c =>
              {
                  ...
                  if (documentRelatesToPatient)
                  {
                      ...
                      ViewContext.Writer.Write(patientFirstName);
                  }
                  else
                  {
...
%>
        <%--<%= Html.ActionLink("Export to Excel", "ExportExcelSentRequests", new {DocumentRequest=Model, ReportType=5} )%>--%>
