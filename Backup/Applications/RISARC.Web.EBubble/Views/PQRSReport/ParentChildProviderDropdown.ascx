<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<RISARC.ACO.Model.Providers>>" %>
        ...
        settings.SetDropDownWindowTemplateContent(c =>
        {
            Html.DevExpress().ListBox(
                listBoxSettings => {
                    ...
                    listBoxSettings.Properties.ValueField = "ProviderId";
                    listBoxSettings.Properties.ValueType = typeof(int);
                    listBoxSettings.Properties.TextField = "ProviderName";
