...
namespace RISARC.Web.EBubble.Controllers
{
    ...
    public class MVCxGridViewState
    {
        public MVCxGridViewState(MVCxGridView gridView)
        {
            ...
            GroupedColumns = new GridViewDataColumnStateCollection(gridView.GetGroupedColumns());
             TotalSummary = new Collection<MVCxSummaryItemState>();
        ...
        public Collection<MVCxSummaryItemState> TotalSummary
        {
            get;
            protected set;
        }
    ...
    public class GridViewDataColumnStateCollection : Collection<GridViewDataColumnState>
    {
