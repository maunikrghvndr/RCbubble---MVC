namespace Telerik.Web.Mvc.Examples
{
    ...
    public static class HtmlHelpersExtensions
    {
        ...
        public static IHtmlString ProductMetaTag(this HtmlHelper html)
        {
            ...
            return String.Format("<meta name=\"ProductId\" content=\"{0}\" />", controllerToProductIdMap[controller]).ToString();
        }


        public static IHtmlString CheckBox(this HtmlHelper html, string id, bool isChecked, string labelText)
        {
            return (html.CheckBox(id, isChecked) + new HtmlElement("label").Attribute("for", id).Html(labelText).ToString()).ToString();
        }

        public static string GetCurrentTheme(this HtmlHelper html)
        {
            return html.ViewContext.HttpContext.Request.QueryString["theme"] ?? "Default"; // "vista";
        }
    ...
    public class ExampleConfigurator : IDisposable
    {
        ...
        {
            string theme = this.htmlHelper.ViewContext.HttpContext.Request.Params["theme"] ?? "default"; // was vista
